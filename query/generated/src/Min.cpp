...
std::string Min::get_type_name() const {
	return "vnx.query.Min";
}

const vnx::TypeCode* Min::get_type_code() const {
	return vnx::query::vnx_native_type_code_Min;
}
...
void Min::accept(vnx::Visitor& _visitor) const {
	const vnx::TypeCode* _type_code = vnx::query::vnx_native_type_code_Min;
...
vnx::Variant Min::get_field(const std::string& _name) const {
	if(_name == "A") {
...
void Min::set_field(const std::string& _name, const vnx::Variant& _value) {
	if(_name == "A") {
		_value.to(A);
...
const vnx::TypeCode* Min::static_get_type_code() {
...
std::shared_ptr<vnx::TypeCode> Min::static_create_type_code() {
...
void write(TypeOutput& out, const ::vnx::query::Min& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::query::vnx_native_type_code_Min;
